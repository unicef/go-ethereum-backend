...
func (db *Service) CreateAssetBlock(
	...
	if !isEmptyText && len(blockText) > 10000 {
		return nil, errors.New("Post text is limited to 10000 characters")
	}
	...
	// err = db.acceptAssetBlock(datatype.ID(blockID), assetID, userID)
	// if err != nil {
	// 	apperrors.Critical("assetservice:CreateAssetBlock:7", err)
	// 	return nil, datatype.ErrServerError
	// }
	return nil, nil
}
